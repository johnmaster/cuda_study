...
for S, K in SKs:
    ...
    '''
    values.to: 将values张量变换类型
    float8_e4m3fn: 8-bit浮点数
        e4: 4位指数
        m3: 3位尾数
        fn: 支持NaN
    '''
    ...
    run_benchmark(torch.sum, values_f8e4m3.half(), "f8e4m3f16_th")
    ...
    run_benchmark(torch.sum, values_f8e5m2.half(), "f8e5m2f16_th")
